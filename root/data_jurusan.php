              ...
              <div class="box">
                ...
                <div class="box-body table-responsive no-padding">
                  ...
                  <table class="table table-hover">
                    <tr>
					 ...
					 <?php
							$sql='select * from jurusan,fakultas WHERE jurusan.kd_fakultas = fakultas.kd_fakultas ORDER BY fakultas.kd_fakultas ';
				...
				?>
                    <tr>
                      ...
                      <td><a href="edit_jurusan.php?kd_jurusan=<?php echo $data['kd_jurusan']; ?>">Edit</a> | <a href="hapus_jurusan.php?kd_jurusan=<?php echo $data['kd_jurusan']; ?>">Hapus</a></td>
                    </tr>
							<?php }?>
                  </table>
                </div><!-- /.box-body -->
