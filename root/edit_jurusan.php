      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Update Data Jurusan</li>
          </ol>
        </section>
              ...
              <div class="box box-primary">
                ...
                <form role="form" action="update_jurusan.php" method="post">
				 <?php
							...
							$query_mysqli = mysqli_query($koneksi,"select * from jurusan,fakultas WHERE jurusan.kd_fakultas = fakultas.kd_fakultas AND kd_jurusan='$kd_jurusan'")or die(mysqli_error($koneksi));
				...
				?>
                  <div class="box-body">
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" name="kd_jurusan" value="<?php echo $data ['kd_jurusan']; ?>" readonly >
                    </div>
					 <div class="form-group">
					...
					<div class="form-group">
                      ...
                      <select name="kd_fakultas" id="select"  class="form-control">
						  <option value="<?php echo $data ['kd_fakultas']; ?>"> <?php echo $data ['nama_fakultas']; ?> </option>
						 <?php 
