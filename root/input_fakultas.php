      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Input Data Fakultas</li>
          </ol>
        </section>
                ...
                <form role="form" action="simpan_fakultas.php" method="post">
                  <div class="box-body">
					...
					<?php										
									...
									$query = "SELECT max(kd_fakultas) as maxKode FROM fakultas";
				 ...
				 ?>
                      ...
                      <input type="text" class="form-control" name="kd_fakultas" value="<?php echo $kodeAkun; ?>" readonly>
                    </div>
					 <div class="form-group">
