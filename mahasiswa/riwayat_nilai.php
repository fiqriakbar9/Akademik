      ...
      <div class="content-wrapper">
        ...
        <section class="content-header">
          ...
          <ol class="breadcrumb">
            ...
            <li class="active">Riwayat Nilai</li>
          </ol>
        </section>
          ...
          <div class="row">
            <div class="col-xs-12">
		      ...
		      <th>Semester</th>
					 ...
					 <?php
							$sql='select * from krs,matakuliah where nim="'.$_SESSION['nim'].'" AND krs.kd_matakuliah = matakuliah.kd_matakuliah ORDER BY krs.semester DESC';
