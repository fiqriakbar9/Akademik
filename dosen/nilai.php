                ...
                <div class="box-body table-responsive no-padding">
                  <table class="table table-hover">
                    <tr>
					 ...
					 <?php
							$sql='select * from krs,matakuliah,data_dosen where krs.kd_matakuliah = matakuliah.kd_matakuliah AND matakuliah.nip = data_dosen.nip AND data_dosen.nip="'.$_SESSION['nip'].'"';
